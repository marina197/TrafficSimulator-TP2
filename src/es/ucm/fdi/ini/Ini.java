...
public class Ini {
	 ...
	 * @throws IniError
	 */
	public Ini(InputStream is) throws IOException, IniError {
		load(is);
	}
	 ...
	 * 
	 * @param is A filename from which the INI structure is read
	 ...
	 * @throws IniError
	 */
	public void load(InputStream is) throws IOException, IniError {
