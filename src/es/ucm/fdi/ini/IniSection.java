...
public class IniSection {
	...
	private void checkKeyValidity(String key)  throws IniError {
		if (key.isEmpty()) {
	 ...
	 */
	public void setValue(String key, Object value) throws IniError{
	...
	public List<String> getKeyComments(String key) throws IniError{
		checkKeyValidity(key);
